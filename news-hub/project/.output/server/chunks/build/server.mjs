import { computed, readonly, hasInjectionContext, inject, getCurrentInstance, toRef, isRef, defineComponent, ref, h, Suspense, Fragment, createApp, provide, shallowReactive, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, shallowRef, isReadonly, isShallow, isReactive, toRaw, defineAsyncComponent, mergeProps, getCurrentScope, useSSRContext } from 'vue';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Dh-ZC2WA.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import('./login-CEfzH7qH.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: { "middleware": "auth" },
    component: () => import('./dashboard-CsKPBULk.mjs')
  },
  {
    name: "news-id",
    path: "/news/:id()",
    meta: { "middleware": "auth" },
    component: () => import('./_id_-C_o06Y30.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Cpw2oJgV.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BExfJCte.mjs'));
...
export { useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useAuth as d, entry$1 as default, useRoute as e, defineNuxtRouteMiddleware as f, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u };
